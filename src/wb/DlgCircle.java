...
public class DlgCircle extends JDialog {
	...
	public DlgCircle() {
		...
		{
			JLabel lblDuzinaStranice = new JLabel("Poluprecnik:");
		...
		}
		{
			...
			contentPanel.add(lblColor, gbc_lblBojaIvice);
		}
		{
			pnlColor = new JPanel();
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						check=true;
							...
							JOptionPane.showMessageDialog(null, "Uneti parametri za krug nisu dobri");
						}
					}
				});
		...
		}
		{
			...
			pnlAreaColor.addMouseListener(new MouseAdapter() {
				public void mouseClicked(MouseEvent e) {
					Color bojaUnutra = JColorChooser.showDialog(null, "Izaberite boju unutrašnjosti:", pnlAreaColor.getBackground());
					pnlAreaColor.setBackground(bojaUnutra);
				}
			});
