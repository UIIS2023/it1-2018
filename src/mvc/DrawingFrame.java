...
public class DrawingFrame extends JFrame implements Observer {
	...
	private JLabel lblOptions = new JLabel("Oprions:");
	...
	private void initialize() {
		...
		JToggleButton tglbtnDonut_1 = new JToggleButton("    Donut    ");
		...
		pnlColor.setLayout(new BorderLayout(0, 0));
		pnlColor.add(pnlAreaColor, BorderLayout.SOUTH);
		...
		pnlColor.add(pnlInsideColor_1, BorderLayout.NORTH);
