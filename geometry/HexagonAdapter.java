...
public class HexagonAdapter extends AreaShape implements Moveable{
	...
	private Hexagon hex;
	//private Hexagon h=new Hexagon(0,0,0);
	...
	*/
	public HexagonAdapter(int x, int y ,int r, Color color) {
		hex=new Hexagon(x,y,r);
		setColor(color);
	}

	public HexagonAdapter(int x, int y ,int r, Color color, Color areaColor) {
		this(x,y,r, color);
